...
summary: 'An electronic gasoline fuel system that sprays fuel into the intake port so air and fuel mix before entering the cylinder.'
status: 'published'
...
Port fuel injection sprays gasoline into the intake port or manifold upstream of the intake valve. Airflow carries the fuel-air mixture into the cylinder during the intake stroke.

## Mechanism

A fuel pump supplies a rail, and electronically controlled injectors meter fuel near each intake port. The engine control unit calculates pulse width from air mass or pressure, engine speed, throttle position, temperature, oxygen-sensor feedback, and transient corrections.
...
Port fuel injection became a mainstream gasoline-engine technology during the emissions-and-electronic-control era. It remains relevant in engines that prioritize cost, emissions stability, or combined port/direct strategies.
...
- [Fuel Injection](/technologies/fuel-injection/) for the broader fuel-metering family.
- [Direct Injection Petrol Engine](/technologies/direct-injection-petrol-engine/) for in-cylinder gasoline injection.
- [Catalytic Converter](/technologies/catalytic-converter/) for why precise mixture control became historically important.
